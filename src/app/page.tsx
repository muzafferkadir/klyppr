    ...
    <div className="relative isolate flex items-center gap-x-2 sm:gap-x-6 overflow-hidden bg-gradient-to-r from-purple-600 to-indigo-600 px-3 py-2 sm:px-6 sm:py-2.5 text-[11px] sm:text-sm sm:before:flex-1 sm:after:flex-1">
      <div className="flex flex-wrap items-center gap-x-2 sm:gap-x-4 gap-y-1 sm:gap-y-2">
        <p className="text-white">
          ...
          <a href="https://github.com/muzafferkadir/klyppr-desktop/releases/download/v1.2.0/Klyppr-1.2.0-arm64.dmg" className="font-medium text-white underline hover:text-gray-200">Mac</a>
          <span className="mx-1 text-white">|</span>
          <a href="https://github.com/muzafferkadir/klyppr-desktop/releases/download/v1.2.0/Klyppr.Setup.1.2.0.x64.exe" className="font-medium text-white underline hover:text-gray-200">Windows</a>
        </p>
        <a
